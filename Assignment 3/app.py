...
train = pd.read_csv("/mnt/e/Assignment 3/data/train.csv")
test = pd.read_csv("/mnt/e/Assignment 3/data/test.csv")
val = pd.read_csv("/mnt/e/Assignment 3/data/validation.csv")
